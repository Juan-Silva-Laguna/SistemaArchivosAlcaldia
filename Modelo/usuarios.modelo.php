...
class Usuarios{
    ...
    {
       $this->consulta="SELECT * FROM usuarios WHERE usuario='$this->user'";
    ...
    public function guardar()
    {
       ...
       $this->consulta="INSERT INTO usuarios VALUES(NULL, '$this->nombre', '$this->correo', '$this->celular', '$this->user', '$hash')";
       $this->resultado=$this->conexion->con->prepare($this->consulta);
       $this->resultado->execute();
       if($this->resultado->rowCount()>=1){
    ...
    {
       $this->consulta="SELECT * FROM usuarios WHERE idUsuario='$this->id'";   
       $this->resultado=$this->conexion->con->prepare($this->consulta);
       $this->resultado->execute();
       return $this->resultado->fetchAll(PDO::FETCH_ASSOC);
    }
    ...
    { 
       ...
       $this->consulta="UPDATE usuarios SET nombre='$this->nombre', correo='$this->correo', celular='$this->celular', usuario='$this->user' $var WHERE idUsuario='$this->id'";
       $this->resultado=$this->conexion->con->prepare($this->consulta);
       $this->resultado->execute();
       if($this->resultado->rowCount()>=1){
    ...
    { 
       $this->consulta="DELETE FROM usuarios WHERE idUsuario='$this->id'";
       $this->resultado=$this->conexion->con->prepare($this->consulta);
       $this->resultado->execute();
       if($this->resultado->rowCount()>=1){
    ...
    {
       $this->consulta="SELECT * FROM usuarios WHERE nombre LIKE '%$this->nombre%' AND correo LIKE '%$this->correo%'AND celular LIKE '%$this->celular%' AND usuario LIKE '%$this->user%'";   
       $this->resultado=$this->conexion->con->prepare($this->consulta);
       $this->resultado->execute();
       return $this->resultado->fetchAll(PDO::FETCH_ASSOC);
    }
